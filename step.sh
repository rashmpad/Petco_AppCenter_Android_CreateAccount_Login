...
appcenter test prepare uitest --artifacts-dir "${ARTIFACTS_DIR}" --app-path "${app_path}" --build-dir "${BUILD_DIR}" --fixture "Petco.UITests.Onboarding_CreateAccount(Android)" --fixture "Petco.UITests.Onboarding_Login(Android)" --debug --quiet
